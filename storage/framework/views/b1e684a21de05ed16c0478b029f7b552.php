    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow">
            ...
            <div class="modal-body text-center">
                <p class="fw-semibold mb-3"><?php echo e(session('success')); ?></p>
...
<?php echo $__env->make('layout.style', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\WebSosial\WebSosial\resources\views/daftar-relawan.blade.php ENDPATH**/ ?>